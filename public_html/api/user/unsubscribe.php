...
if ($row['used_at']) {
    echo page('✅', 'Вже відписано', "Адресу <strong>{$row['email']}</strong> вже видалено з маркетингової розсилки.");
    exit;
}
...
echo page(
    ...
    "Привіт, <strong>{$name}</strong>!<br><br>
     Адресу <strong>{$email}</strong> успішно видалено з маркетингової розсилки.<br><br>
