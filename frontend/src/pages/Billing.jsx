...
export default memo(function Billing({ currentPlan }) {
  return (
    <div>
      ...
      <div style={{
        marginTop: 32, padding: 24, background: C.card,
...
const PADDLE_TOKEN = "live_5479fe94fca51b60d7791b81725";
      ...
      <div>
        ...
        <div style={{ marginBottom: 10, display: "flex", flexDirection: "column", gap: 6 }}>
          {priceList.map(p => (
            <label key={p.id}
              ...
              {p.interval === "year" && (
                <span style={{
                  fontSize: 10, background: "rgba(0,255,136,0.1)",
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <button onClick={handleBuy} disabled={!selected || step === "paying"}
            style={{
              ...btnStyle(true), flex: 2, padding: "10px",
    ...
    <div style={{
      ...
      <div style={{ marginBottom: 20 }}>
        <span style={{
          ...
          color: isEnterprise ? purple : C.white
        }}>{p.price}</span>
      ...
      {isCurrent ? (
        <div style={{
          textAlign: "center", fontSize: 13, color: isEnterprise ? purple : C.green,
        ...
        <button onClick={() => window.open("https://t.me/indexfastgoogle?text=Хочу%20дізнатись%20про%20Enterprise%20план", "_blank")}
          style={{
            width: "100%", background: "rgba(147,112,219,0.1)",
